    ...
    timeline: [
      {
        title: "Self Learning",
        date: "2024 — present",
        text: "I am learning web development and programming languages. I am learning HTML, CSS, JavaScript, React, Node.js, Express.js, Python, C, C++, Java, etc. I am also learning UI/UX design.",
      },
      {
