...
export default function Home() {
  ...
  const TESTIMONIALS = [
    ...
    },
    {
      name: "Henry william",
      avatar: image4,
      text: "I am very happy with the work done by Vishakha. She was hired to create a website and he did it very well. She has a lot of experience and is very concerned about the needs of client.",
    },
  ];
